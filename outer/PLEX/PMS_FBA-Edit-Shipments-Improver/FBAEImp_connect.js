// ==UserScript==
// @name         PMS FBA Edit Shipments Improver
// @version      1.0
// @description  Improve PMS FBA Shipments Workflow
// @author       Priboy313
// @match        https://pms.plexsupply.com/pms/editfba.xhtml
// @match        https://pms.plexsupply.com/pms/editfba.xhtml?*
// @match        https://pms.officechase.com/pms/editfba.xhtml
// @match        https://pms.officechase.com/pms/editfba.xhtml?*
// @match        https://pms.marksonsupply.com/pms/editfba.xhtml
// @match        https://pms.marksonsupply.com/pms/editfba.xhtml?*
...
(function() {
	'use strict';
	if (window.isFbaEditImproverRunning) return;
	window.isFbaEditImproverRunning = true;

	const SCRIPT_NAME = "fbaEditShipmentsImprover";
	...
	const SCRIPT_URL_TEMPLATE = 'https://cdn.jsdelivr.net/gh/Priboy313/Priboy313.github.io@{commit_hash}/outer/PLEX/PMS_FBA-Edit-Shipments-Improver/FBAEImp_public.js';
	
	const CACHE_KEY = 'FBA-E-Impover-cache';
