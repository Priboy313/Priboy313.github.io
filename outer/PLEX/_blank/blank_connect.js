...
(function() {
	'use strict';
	if (window.isConnectorRunning) return;
	window.isConnectorRunning = true;

	const SCRIPT_NAME = "InvValueObserver";
	const GITHUB_TOKEN = [].join("");
	const GITHUB_API_URL = 'https://api.github.com/repos/Priboy313/Priboy313.github.io/commits/main';
	const SCRIPT_URL_TEMPLATE = 'https://cdn.jsdelivr.net/gh/';
